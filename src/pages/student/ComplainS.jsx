...
// Import SideNavS component
import SideNavS from './SideNavS';

const drawerWidth = 240; // Define the width of your SideNavS
...
const useStyles = makeStyles((theme) => ({
  ...
  // Adjust the style for SideNavS integration
  content: {
    marginLeft: drawerWidth, // Adjusted to create space for SideNavS
    marginRight: drawerWidth, // Adjusted to create space for SideNavS
    padding: theme.spacing(3),
                  ...
                  <Grid item xs={12}>
                    <FormControl variant="outlined" fullWidth>
                      ...
                      <Select
                        ...
                        value="Student" // Set the value to "Student" to make it selected by default
                        onChange={handleFacultyOrStudentChange}
                        label="Faculty or Student"
                        style={{ color: '#2196f3' }}
                      >
                        <MenuItem value="Student">Student</MenuItem> {/* Change the value and label */}
                      </Select>
                    </FormControl>
                  </Grid>
                  <Grid item xs={12}>
